 ...
 * ровно там, где прячется разница в сотни тысяч: техника, мойка,
 * столешница, доводчики, подсветка и работы. Подъём на этаж заведён
 * отдельно: это самая частая доплата, о которой узнают в день доставки.
 *
